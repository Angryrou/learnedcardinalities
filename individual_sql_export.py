...
for prefix, name, path in [
    ("tr", "train", "data/train.csv"),
    ("syn", "synthetic", "workloads/synthetic.csv"),
    ("jl", "job-light", "workloads/job-light.csv"),
]:
    ...
    for i, row in df_train.iterrows():
        ...
        if isinstance(col_predicates, str):
            ...
            col_predicates = " AND ".join(
                [
                    f"{col_predicates_strs[i * 3]}{col_predicates_strs[i * 3 + 1]}{col_predicates_strs[i * 3 + 2]}"
